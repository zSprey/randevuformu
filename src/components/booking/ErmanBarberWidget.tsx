      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-7 shadow-md overflow-hidden">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4 text-center sm:text-left">
            <div className="relative w-16 h-16 rounded-2xl bg-[#0F2A4A] border border-[#0F2A4A]/20 text-white flex items-center justify-center shadow-md shrink-0">
        ...
        <div className="mt-5 pt-4 border-t border-slate-100 grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
          ...
          <div className="p-3 rounded-xl bg-slate-50/80 border border-slate-200/80 flex flex-col justify-between sm:col-span-2 lg:col-span-1">
            <span className="font-bold text-[#0F2A4A] flex items-center gap-1.5 mb-1.5">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#0062FF]" /> Salon Olanakları
            </span>
            <div className="flex flex-wrap gap-1.5 text-[11px] text-slate-600">
              {amenities.map((item, idx) => {
                const lower = item.toLowerCase();
                let IconComponent = CheckCircle2;
                let iconColor = "text-[#0062FF]";
                ...
                >
                  ...
                  {extraServices.length > 0 && (
                    <div className="mt-5 pt-5 border-t border-slate-100 space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <PlusCircle className="w-4 h-4 text-[#0062FF]" />
                  ...
                  <div className="pt-4 flex justify-end">
                    <button
                      type="button"
                      onClick={() => setStep(2)}
                      className="px-6 py-2.5 rounded-xl bg-[#0F2A4A] hover:bg-[#163a66] active:scale-[0.98] text-white font-medium text-xs shadow-xs border border-[#0F2A4A]/10 transition-all flex items-center gap-2 cursor-pointer"
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="pt-2 border-t border-slate-100">
                          {!showWaitlistForm ? (
                            ...
                            >
                              <Bell className="w-3.5 h-3.5 text-[#0062FF]" />
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      {selectedExtraServices.length > 0 && (
                        <div className="flex items-start justify-between text-indigo-700 text-[11px] pt-1.5 border-t border-slate-200/60">
                          <span className="font-medium flex items-center gap-1">
                            <PlusCircle className="w-3 h-3 text-[#0062FF]" /> Ekstra Hizmetler:
                          </span>
                          <span className="font-semibold text-right">
                            {selectedExtraServices.map((s) => s.name).join(", ")}
                          </span>
                    ...
                    <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-7 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white text-xs font-semibold shadow-xs flex items-center gap-1.5 transition-all disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                      >
